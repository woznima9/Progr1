...
public class BlackJack {
    ...
    private static void wyswietlanieKontrolne() {
...
//            System.out.println(sbTalia);                              // wyświetli kontrolnie karty w potasowanej talii
    ...
    private static void tasowanie(Random random) {
        int positionOn;
        int positionOff;
        do {
    ...
    private static void generowanieKart() {
        int orderedDeck = 0;
